...
function RenderingList() {
    ...
    var employeeList = employees.map(employee  =>  <div key={employee.id}>{employee.name}</div>)

    //traversing names array
    var names = ['Zeeshan', 'Shahid', 'Farhan', 'Shahzaib']
    var nameList = names.map((name,index) => <div key={index}>{index} {name}</div>)
    return (
        <div>
            {/* {nameList} */}
            {employeeList}
